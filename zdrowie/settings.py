...
SECRET_KEY = 'django-insecure-uu^&fdts0mcmv8z)d6=sx=79h5^&i5*eia+7usejkqdb=dgom9'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'zdrowie' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
OSM_USER_AGENT = os.environ.get("OSM_USER_AGENT", "ZdrowieApp/1.0 (zdrowieapp2025@gmail.com)")
